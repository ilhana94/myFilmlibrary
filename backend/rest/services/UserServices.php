...
class UserServices extends BaseServices {  // 👈 Promijeni u "UserServices" (s na kraju)
    public function __construct() {
        parent::__construct(new \rest\dao\UsersDao());  // 👈 Dodaj namespace
    }
    ...
    protected function validateData($data, $action) {
        ...
        if(!isset($data['username']) || trim($data['username']) === '') {
            throw new \Exception("Username is required");  // 👈 Dodaj backslash
        }
